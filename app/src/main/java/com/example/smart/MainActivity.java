...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String sofa_url = "https://github.com/Mritunjay-2001";
    private ModelRenderable modelRenderable;
    private String Model_URL = "https://github.com/Mritunjay-2001";
...
/*
        ...
        //https://github.com/Mritunjay-2001/App-Templates/master/Resources/gaming_chair_xyz_school_homework/scene.gltf
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String str="https://github.com/Mritunjay-2001/glTF-Sample-Models/master/2.0/SheenChair/glTF/SheenChair.gltf";
                start_intent(str);
            }
        });
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String str="https://github.com/Mritunjay-2001/App-Templates/master/Resources/chair/arm_chair__furniture/scene.gltf";
                start_intent(str);
            }
        });
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String str="https://github.com/Mritunjay-2001/App-Templates/master/Resources/victorian_lounge_sofa/scene.gltf";
                start_intent(str);
            }
        });
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String str="https://github.com/Mritunjay-2001/App-Templates/master/Resources/office%20essentials%20and%20cabinets/gaming_chair_1-_black/scene.gltf";
                start_intent(str);
            }
        });
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String str="https://github.com/Mritunjay-2001/App-Templates/master/Resources/sofa_6/scene.gltf";
                start_intent(str);
            }
        });
        ...
        button7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String str="https://github.com/Mritunjay-2001/App-Templates/master/Resources/the_matrix_red_chesterfield_chair/scene.gltf";
                start_intent(str);
            }
        });
        ...
        button8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String str="https://github.com/Mritunjay-2001/App-Templates/master/Resources/sofas/sofa_game_ready__2k_pbr/scene.gltf";
                start_intent(str);
            }
        });
